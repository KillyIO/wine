...
class Palettes {
  // static const Color purple = Color(0xFF726EFF);
  // static const Color lightCyan = Color(0xFF5AFFE7);
  // static const Color strongCyan = Color(0xFF08C6AB);
  // static const Color lightBlue = Color(0xFF66C7FF);
  ...
  static const Color warning = Color(0xFFFFCB3A);
}
