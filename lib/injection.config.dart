...
import 'application/library/library_bloc.dart' as _i27;
import 'application/log_in/log_in_bloc.dart' as _i28;
import 'application/series/series_bloc.dart' as _i29;
import 'application/settings/settings_bloc.dart' as _i30;
import 'application/setup/setup_bloc.dart' as _i31;
...
import 'domain/default_covers/i_default_covers_repository.dart' as _i21;
import 'domain/series/i_series_repository.dart' as _i14;
import 'domain/sessions/i_sessions_repository.dart' as _i23;
import 'domain/settings/i_settings_repository.dart' as _i25;
...
import 'infrastructure/default_covers/default_covers_repository.dart' as _i22;
import 'infrastructure/series/series_repository.dart' as _i15;
import 'infrastructure/sessions/sessions_repository.dart' as _i24;
import 'infrastructure/settings/settings_repository.dart' as _i26;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i19.TypewriterChapterBloc>(() => _i19.TypewriterChapterBloc(),
      registerFor: {_dev, _prod});
  ...
  gh.lazySingleton<_i23.ISessionsRepository>(
      () => _i24.SessionsRepository(get<_i5.FirebaseAuth>(), get<_i18.Isar>()),
      registerFor: {_dev, _prod});
  gh.lazySingleton<_i25.ISettingsRepository>(
      () => _i26.SettingsRepository(get<_i5.FirebaseAuth>(), get<_i18.Isar>()),
      registerFor: {_dev, _prod});
  gh.factory<_i27.LibraryBloc>(
      () => _i27.LibraryBloc(
          get<_i14.ISeriesRepository>(), get<_i23.ISessionsRepository>()),
      registerFor: {_dev, _prod});
  gh.factory<_i28.LogInBloc>(
      () => _i28.LogInBloc(get<_i10.IAuthFacade>(),
          get<_i23.ISessionsRepository>(), get<_i16.IUserRepository>()),
      registerFor: {_dev, _prod});
  gh.factory<_i29.SeriesBloc>(
      () => _i29.SeriesBloc(
          get<_i10.IAuthFacade>(),
          get<_i12.IChapterRepository>(),
          get<_i14.ISeriesRepository>(),
          get<_i23.ISessionsRepository>(),
          get<_i25.ISettingsRepository>(),
          get<_i16.IUserRepository>()),
      registerFor: {_dev, _prod});
  gh.factory<_i30.SettingsBloc>(
      () => _i30.SettingsBloc(get<_i10.IAuthFacade>(),
          get<_i23.ISessionsRepository>(), get<_i25.ISettingsRepository>()),
      registerFor: {_dev, _prod});
  gh.factory<_i31.SetupBloc>(
      () => _i31.SetupBloc(
          get<_i10.IAuthFacade>(),
          get<_i21.IDefaultCoversRepository>(),
          get<_i23.ISessionsRepository>(),
          get<_i25.ISettingsRepository>(),
          get<_i16.IUserRepository>()),
      registerFor: {_dev, _prod});
  gh.factory<_i32.SignUpBloc>(
      () => _i32.SignUpBloc(get<_i10.IAuthFacade>(),
          get<_i23.ISessionsRepository>(), get<_i16.IUserRepository>()),
      registerFor: {_dev, _prod});
  gh.factory<_i33.TypewriterSeriesBloc>(
      () => _i33.TypewriterSeriesBloc(get<_i21.IDefaultCoversRepository>(),
          get<_i14.ISeriesRepository>(), get<_i23.ISessionsRepository>()),
      registerFor: {_dev, _prod});
  return get;
}
