...
import 'package:wine/presentation/layouts/library/library_layout.dart';
    ...
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        body: MultiBlocProvider(
          providers: [
            BlocProvider(
              create: (context) => getIt<LibraryDatabaseBloc>()
                ..add(const LibraryDatabaseEvent.libraryLaunchedEVT()),
            ),
            BlocProvider(
