// SECTION: Common
const int testTimeStamp = 854841600000;
const String testCoverURL = 'https://www.website.com/cover.png';
const String testGenre = 'horror';
const String testLicence = 'ccBy';
...
const String testStory = '''
nisi vitae suscipit tellus mauris a diam maecenas sed enim ut sem viverra
...
lobortis mattis aliquam faucibus purus in massa tempor nec feugiat nisl
...
in nisl nisi scelerisque eu ultrices vitae auctor eu augue ut lectus arcu
bibendum at varius vel pharetra vel turpis nunc eget lorem dolor sed viverra
ipsum nunc aliquet bibendum enim facilisis gravida neque convallis a cras
semper auctor neque vitae tempus quam pellentesque nec nam aliquam sem et
tortor consequat id porta nibh venenatis cras sed felis eget velit aliquet
sagittis id consectetur purus ut faucibus pulvinar elementum integer enim
neque volutpat ac tincidunt vitae semper quis lectus nulla at volutpat diam ut
venenatis tellus in metus vulputate eu scelerisque felis imperdiet proin
fermentum leo vel orci porta non pulvinar neque laoreet suspendisse interdum
consectetur libero id faucibus nisl tincidunt eget nullam non nisi est sit
amet facilisis magna etiam tempor orci eu lobortis elementum nibh tellus
...
''';
const String testStoryEmpty = '';

// SECTION: Series
const String testSeriesUID = 'afab8f35-c48f-422c-91d8-629659adc979';
