...
import 'application/settings/settings_bloc.dart' as _i22;
import 'application/setup/setup_bloc.dart' as _i23;
import 'application/sign_up/sign_up_bloc.dart' as _i24;
...
import 'infrastructure/core/hive_injectable_module.dart' as _i28;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i22.SettingsBloc>(
      () => _i22.SettingsBloc(get<_i8.IAuthFacade>(),
          get<_i15.ISessionsRepository>(), get<_i17.ISettingsRepository>()),
      registerFor: {_dev, _prod});
  gh.factory<_i23.SetupBloc>(
      () => _i23.SetupBloc(
          get<_i8.IAuthFacade>(),
  ...
  gh.factory<_i24.SignUpBloc>(
      () => _i24.SignUpBloc(get<_i8.IAuthFacade>(),
          get<_i15.ISessionsRepository>(), get<_i19.IUserRepository>()),
      registerFor: {_dev, _prod});
  gh.factory<_i25.AuthBloc>(() => _i25.AuthBloc(get<_i8.IAuthFacade>()),
      registerFor: {_dev, _prod});
  gh.factory<_i26.HomeBloc>(() => _i26.HomeBloc(get<_i7.HomeNavigationBloc>()),
      registerFor: {_dev, _prod});
  return get;
}
...
class _$HiveInjectableModule extends _i28.HiveInjectableModule {}
