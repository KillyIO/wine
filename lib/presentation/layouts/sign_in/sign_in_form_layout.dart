...
import 'package:wine/presentation/utils/sign_in/sign_in_listeners.dart';
import 'package:wine/presentation/widgets/sign_in/sign_in_form.dart';
...
class _SignInFormLayoutState extends State<SignInFormLayout>
            ...
            builder: (context, siDbState) {
              return SafeArea(
                child: Stack(
                  children: <Widget>[
                    SignInForm(
                      siAuthState: siAuthState,
                      siAuthMethods: _siAuthMethods,
                    ),
                    WINELoadingScreen(
                        vsync: this,
                        isLoading:
                            siAuthState.isSubmitting || siDbState.isUpdating),
                  ],
                ),
              );
            },
