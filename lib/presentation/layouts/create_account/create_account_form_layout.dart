...
import 'package:wine/presentation/utils/create_account/create_account_listeners.dart';
import 'package:wine/presentation/widgets/create_account/create_account_form.dart';
import 'package:wine/presentation/widgets/wine_loading_screen.dart';

/// @nodoc
class CreateAccountFormLayout extends StatefulWidget {
  @override
  _CreateAccountFormLayoutState createState() =>
      _CreateAccountFormLayoutState();
}

class _CreateAccountFormLayoutState extends State<CreateAccountFormLayout>
  ...
  void _onPasswordChanged() => context
      ...
      .add(CreateAccountAuthenticationEvent.passwordChangedEVT(
