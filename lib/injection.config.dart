...
import 'application/sign_up/sign_up_bloc.dart' as _i23;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.factory<_i23.SignUpBloc>(
      () => _i23.SignUpBloc(get<_i8.IAuthFacade>(),
          get<_i15.ISessionsRepository>(), get<_i19.IUserRepository>()),
      registerFor: {_dev, _prod});
  gh.factory<_i24.AuthBloc>(() => _i24.AuthBloc(get<_i8.IAuthFacade>()),
      registerFor: {_dev, _prod});
  gh.factory<_i25.HomeBloc>(() => _i25.HomeBloc(get<_i7.HomeNavigationBloc>()),
      registerFor: {_dev, _prod});
  return get;
}
